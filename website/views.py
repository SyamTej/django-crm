...
def customer_record(request, pk):
	if request.user.is_authenticated:
		...
		messages.success(request, "You must be logged in the view Page ")
		return redirect('home')
...
def delete_record(request, pk):
	if request.user.is_authenticated:
		...
		messages.success(request, "You must be logges in to do that... ")
		return redirect('home')
...
def update_record(request, pk):
	if request.user.is_authenticated:
		...
		if form.is_valid():
			form.save()
			messages.success(request, "Record has been succesfully")
			return redirect('home')
